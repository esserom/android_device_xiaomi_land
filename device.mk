...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/qdcm_calib_data_hx8394F_HD720p_video_BOE.xml:system/vendor/etc/qdcm_calib_data_hx8394F_HD720p_video_BOE.xml \
    $(LOCAL_PATH)/configs/qdcm_calib_data_ili9881c_HD720p_video_Tianma.xml:system/vendor/etc/qdcm_calib_data_ili9881c_HD720p_video_Tianma.xml \
    $(LOCAL_PATH)/configs/qdcm_calib_data_nt35521s_HD720p_video_EBBG.xml:system/vendor/etc/qdcm_calib_data_nt35521s_HD720p_video_EBBG.xml
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/keylayout/ist30xx_ts_input.kl:system/vendor/usr/keylayout/ist30xx_ts_input.kl \
    $(LOCAL_PATH)/keylayout/msm8952-sku1-snd-card_Button_Jack.kl:system/vendor/usr/keylayout/msm8952-sku1-snd-card_Button_Jack.kl \
...
# Perf configuration
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/perf/powerhint.xml:system/vendor/etc/powerhint.xml \
    $(LOCAL_PATH)/configs/perf/perfboostsconfig.xml:system/vendor/etc/perf/perfboostsconfig.xml \
    $(LOCAL_PATH)/configs/perf/perf-profile0.conf:system/vendor/etc/perf/perf-profile0.conf \
    $(LOCAL_PATH)/configs/perf/targetconfig.xml:system/vendor/etc/perf/targetconfig.xml \
    $(LOCAL_PATH)/configs/perf/targetresourceconfigs.xml:system/vendor/etc/perf/targetresourceconfigs.xml
